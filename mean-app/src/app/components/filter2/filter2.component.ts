import { Component, OnInit, DoCheck, Output, EventEmitter, Input, OnDestroy } from '@angular/core';
...
export class Filter2Component implements OnInit, DoCheck, OnDestroy {
